...
import { Zap, Shield, Award, ArrowRight, ShoppingBag } from 'lucide-react';
            ...
            <div key={p.id}
              ...
              <div className="p-7">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to={p.href} data-hover
                    className="w-10 h-10 rounded-full bg-crimson/8 flex items-center justify-center hover:bg-crimson transition-colors duration-300 group/btn">
